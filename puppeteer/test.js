...
(async () => {
    ...
    try{
    await page.goto('https://8081-fcffadaabbaeefcdaacfeeefefcbfbadfaaaadbadbdddb.project.examly.io/');
...
(async () => {
  ...
  await page.setViewport({
    ...
    console.log('TESTCASE:FE_adminThemeMenuOperation:success');
  }
   catch(e){
    console.log('TESTCASE:FE_adminThemeMenuOperation:failure');
  }finally{
    await page.close();
    await browser.close();
  }
